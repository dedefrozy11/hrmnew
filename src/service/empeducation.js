...
export default {
  getemployee(params, callback, errCallback) {
    ...
    return Api()
      .get("/hrm/_table/employeeeducation", {
        params: params
      })
      .then(data => {
        callback(data);
  ...
  deleteemployee(id, callback, errCallback) {
    return Api()
      .delete("/hrm/_table/employeeeducation/" + id)
      .then(data => {
        callback(data);
      })
      .catch(error => {
  ...
  editemployee(id, data, callback, errCallback) {
    return Api()
      .put("/hrm/_table/employeeeducation/" + id, data)
      .then(data => {
        callback(data);
      })
      .catch(error => {
  ...
  addemployee(data, callback, errCallback) {
    ...
    console.log(resData);
    return Api()
      .post("/hrm/_table/employeeeducation/", resData)
      .then(data => {
        callback(data);
      })
      .catch(error => {
