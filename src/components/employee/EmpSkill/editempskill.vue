    ...
    <v-stepper-items>
      <v-form ref="form" v-model="valid" lazy-validation>
        <v-stepper-content step="1">
          <h2>Form Edit Info Skill Karyawan</h2>
          ...
          <v-container>
            <v-layout flex wrap row>
              ...
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.level" label="Level"></v-text-field>
              </v-flex>
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.type" label="Jenis"></v-text-field>
              </v-flex>
...
<script>
import employeeApi from "@/service/empskill";
export default {
  // e1: '#app',
  props: {
    editedItem: Object
