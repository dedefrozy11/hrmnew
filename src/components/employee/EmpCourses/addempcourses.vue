    ...
    <v-stepper-items>
      <v-form ref="form" v-model="valid" lazy-validation>
        <v-stepper-content step="1">
          <h2>Form Tambah Data Kursus Karyawan</h2>
          ...
          <v-container>
            <v-layout flex wrap row>
              ...
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.name" label="Nama Acara"></v-text-field>
              </v-flex>
              <!-- <v-flex d-flex lg6>
                <v-menu
                  ref="menu"
              ...
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.year" label="Tahun"></v-text-field>
              </v-flex>
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.time" label="Waktu/Bulan (Angka)"></v-text-field>
              </v-flex>
              <v-flex xs12 sm6 d-flex>
                <v-select
                  :items="items1"
...
import employeeApi from "@/service/empcourses";
export default {
  // e1: '#app',
  data: vm => ({
    items1: [
