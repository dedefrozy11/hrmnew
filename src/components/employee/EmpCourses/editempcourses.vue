    ...
    <v-stepper-items>
      <v-form ref="form" v-model="valid" lazy-validation>
        <v-stepper-content step="1">
          <h2>Form Edit Info Kursus Karyawan</h2>
          ...
          <v-container>
            <v-layout flex wrap row>
              ...
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.time" label="Waktu/Bulan"></v-text-field>
              </v-flex>
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.timeType" label="Jenis Waktu"></v-text-field>
              </v-flex>
