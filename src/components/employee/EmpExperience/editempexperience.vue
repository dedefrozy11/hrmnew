    ...
    <v-stepper-items>
      <v-form ref="form" v-model="valid" lazy-validation>
        <v-stepper-content step="1">
          <h2>Form Edit Pengalaman Karyawan</h2>
          ...
          <v-container>
            <v-layout flex wrap row>
              ...
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.startMonth" label="Mulai Bulan"></v-text-field>
              </v-flex>
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.staryYear" label="Tahun Masuk"></v-text-field>
              </v-flex>
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.endMonth" label="Akhir Bulan"></v-text-field>
              </v-flex>
              <v-flex d-flex lg6>
                <v-text-field v-model="editedData.endYear" label="Tahun Keluar"></v-text-field>
              </v-flex>
              <v-flex d-flex lg6>
