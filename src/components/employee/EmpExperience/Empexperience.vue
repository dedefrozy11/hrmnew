  ...
  <v-card>
    <v-card-title>
      <v-flex xs10 sm10 md10 lg10>
        <h4>Pengalaman Kerja Karyawan</h4>
      </v-flex>
    ...
    >
      <template slot="items" slot-scope="props">
        ...
        <td class="text-xs-left">{{ props.item.startMonth }}</td>
        <td class="text-xs-left">{{ props.item.staryYear }}</td>
        <td class="text-xs-left">{{ props.item.endMonth }}</td>
