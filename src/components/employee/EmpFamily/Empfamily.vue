    ...
    >
      <template slot="items" slot-scope="props">
        ...
        <td class="text-xs-left">
          <div v-if="props.item.relationship == '1'">Ayah</div>
          <div v-else-if="props.item.relationship == '2'">Ibu</div>
          <div v-else-if="props.item.relationship == '3'">Wali</div>
          <div v-else>SD</div>
        </td>
        ...
        <td class="text-xs-left">
          <div v-if="props.item.education == '1'">Universitas</div>
          <div v-else-if="props.item.education == '2'">SMA/K</div>
          <div v-else-if="props.item.education == '3'">SMP</div>
          <div v-else>SD</div>
        </td>
        <td class="text-xs-left">
          <div v-if="props.item.education == '1'">WNI</div>
          <div v-else>WNA</div>
        </td>
        <td class="text-xs-left">
